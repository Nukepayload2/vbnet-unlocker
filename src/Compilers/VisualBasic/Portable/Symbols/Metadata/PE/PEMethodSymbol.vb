...
#End Region
        ...
        Private Sub DeriveCompilerFeatureRequiredUseSiteInfo(ByRef errorInfo As DiagnosticInfo)
            ...
            errorInfo = DeriveCompilerFeatureRequiredAttributeDiagnostic(Me, DirectCast(containingModule, PEModuleSymbol), Handle, If(MethodKind = MethodKind.Constructor, CompilerFeatureRequiredFeatures.RequiredMembers, CompilerFeatureRequiredFeatures.None), decoder)
            If errorInfo IsNot Nothing Then
                Return
            End If
